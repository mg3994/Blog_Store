...
import '../features/app_setting/data/datasources/app_setting_local_datasource.dart';
...
final class Dependencies {
  ...
  late final AppSettingRepository appSettingRepository = AppSettingRepositoryImpl(
    localDataSource: appSettingLocalDataSource,
    analyticsGateway: analyticsGateway,
  );

  late final GetAppSettings getAppSettings = GetAppSettings(appSettingRepository);
  late final WatchAppSettings watchAppSettings = WatchAppSettings(appSettingRepository);
  late final UpdateThemeMode updateThemeMode = UpdateThemeMode(appSettingRepository);
  late final UpdateLocale updateLocale = UpdateLocale(appSettingRepository);
  late final UpdateSeedColor updateSeedColor = UpdateSeedColor(appSettingRepository);
